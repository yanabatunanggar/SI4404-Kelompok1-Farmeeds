...
@foreach ($users as $user)
    ...
    <form class="custom-form volunteer-form mb-5 mb-lg-0" action="/updateProfile/{{ $user->id }}" method="post" enctype="multipart/form-data">
        @csrf
        <h3 class="mb-4">Ubah akun Anda</h3>

        <div class="row">
            <div class="col-lg-6 col-12">
                <label class="input-group-text" for="nama_lengkap">Nama Lengkap</label>
            ...
            <div class="col-lg-6 col-12">
                <label class="input-group-text" for="nama_lengkap">Nomor HP</label>
            ...
            <div class="col-lg-12 col-12">
                <label class="input-group-text" for="nama_lengkap">Nama Kelompok Tani</label>
