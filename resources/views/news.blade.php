                ...
                <div class="col-lg-7 col-12">
                    <div class="news-block">
                        ...
                        <div class="news-block-info">
                            ...
                            <div class="news-block-title mb-2">
                                <h4><a href={{ '/news-detail' }}" class="news-block-title-link">Clothing donation to urban area</a></h4>
                            </div>
                    ...
                    <div class="news-block mt-3">
                        ...
                        <div class="news-block-info">
                            ...
                            <div class="news-block-title mb-2">
                                <h4><a href="{{ '/news-detail' }}" class="news-block-title-link">Food donation area</a></h4>
                            </div>
                ...
                <div class="col-lg-4 col-12 mx-auto mt-4 mt-lg-0">
                    ...
                    <div class="news-block news-block-two-col d-flex mt-4">
                        ...
                        <div class="news-block-two-col-info">
                            <div class="news-block-title mb-2">
                                <h6><a href="{{ '/news-detail' }}" class="news-block-title-link">Food donation area</a></h6>
                            </div>
                    ...
                    <div class="news-block news-block-two-col d-flex mt-4">
                        ...
                        <div class="news-block-two-col-info">
                            <div class="news-block-title mb-2">
                                <h6><a href="{{ '/news-detail' }}" class="news-block-title-link">Volunteering Clean</a></h6>
                            </div>
